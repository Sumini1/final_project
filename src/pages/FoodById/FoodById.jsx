    ...
    <div className="bg-gray-400  dark:bg-gray-700 min-h-screen pb-10">
      ...
      <div className=" flex items-center justify-center py-5 ">
        ...
        >
          ...
          <div className="flex justify-normal gap-4 items-start w-[40rem] mx-auto text-white font-[lemon] my-4">
          ...
          <div className="flex justify-between mx-7">
            ...
            <Link to={`/update-food-by-id/${param.id}`}>
              <button
                ...
                className="bg-gradient-to-r from-primary to-secondary text-white  rounded-full hover:scale-105 duration-200 w-[70px] p-1 m-1 mt-[-15px]"
              >
                Update
              </button>
            </Link>
